...
[dLL] = do_lik_boot_cat(E, dispbin, dispnamesbin, scale, niteruse); %make figures and extrace difference in log likelihood between H0 and HA
...
[totmat] = getcatfit(E, dispbin, scale, 1, Awfit); %fit analytical models I and II to data
...
figure(3);
[modfit]=do_lik_boot_cont(Etree, h0, dbhquant, niteruse, plotxname, unlog); %make figures and extrace log likelihood
...
figure(3);
[modfit]=do_lik_boot_cont_fitting(Etree, h0, dbhquant, niteruse, plotxname, unlog, Awfit);
%modfit.totfit
